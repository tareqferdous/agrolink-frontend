...
export default function ListingBidCard({
  ...
  return (
    <div className='bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden shadow-sm'>
      <div className='px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-800/70 flex items-center justify-between'>
        <div>
          <Link
            href={listingBidsHref}
            className='font-bold text-gray-900 dark:text-gray-100 hover:text-green-600 dark:hover:text-green-400 transition-colors flex items-center gap-2 group w-fit'>
            🌾 {item.cropName}
            <svg
        ...
        <div className='text-right space-y-2'>
          ...
          <Link
            href={listingBidsHref}
            className='inline-flex items-center gap-1 px-3 py-1.5 rounded-lg border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-semibold hover:bg-green-100 dark:hover:bg-green-900/50 transition-colors'>
            View details
            <svg
            ...
            <div
              ...
              className={`px-6 py-4 flex items-center justify-between transition-colors ${
                isHighest
                  ...
                  : "hover:bg-gray-50/50 dark:hover:bg-gray-800/60"
              }`}>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  ...
                  {bid.buyerNote && (
                    <p className='text-xs text-gray-500 dark:text-gray-400 mt-1 italic bg-gray-50 dark:bg-gray-800 px-2 py-1 rounded-lg border border-gray-100 dark:border-gray-700'>
