      ...
      {[...Array(2)].map((_, i) => (
        <div
          ...
          <div className='px-6 py-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700'>
            ...
            <div className='h-3 bg-gray-200 dark:bg-gray-700 rounded animate-pulse w-20 mt-2' />
          </div>
          {[...Array(2)].map((_, j) => (
            <div
              key={j}
              ...
              <div className='h-8 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse w-20' />
            </div>
          ))}
        </div>
      ))}
